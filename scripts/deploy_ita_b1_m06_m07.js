...
async function updateB1Metadata() {
    ...
    console.log('✅ Updated b1 count to 7');
}

async function run() {
    try {
        await uploadB1Module('ita_b1_m06');
        await uploadB1Module('ita_b1_m07');
        await updateB1Metadata();
        console.log('\n🎉 ITALIAN B1 MODULES 06 & 07 DEPLOYED!');
    } catch (error) {
