...
async function uploadChineseA1Module03() {
    try {
        console.log('🚀 Starting Chinese A1 Module 03 upload...\n');

        // Read the JSON file
        const filePath = path.join(__dirname, '../firestore_data/zh_a1_m03.json');
        ...
        // Upload to Firestore: languages/chinese/levels/a1/modules/zh_a1_m03
        ...
        console.log('🎉 Chinese A1 Module 03 deployment complete!');
