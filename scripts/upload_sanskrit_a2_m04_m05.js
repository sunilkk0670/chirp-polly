...
async function uploadSanskritA2M04M05() {
    const modules = ['sa_a2_m04', 'sa_a2_m05'];

    console.log(`📤 Starting upload for Sanskrit A2 Modules 04 & 05...\n`);
    ...
    try {
        ...
        console.log('═══════════════════════════════════════════════════════');
        console.log('🌟 SANSKRIT A2 MODULES 04 & 05 DEPLOYED! 🌟');
        console.log('═══════════════════════════════════════════════════════\n');
        console.log('📊 Summary:');
        console.log('   • 200 Sanskrit A2 words uploaded (Modules 04 & 05)');
        console.log('   • 500 total words across 5 modules');
        console.log('   • 20 nested lessons created');
        console.log('   • Module 04: Advanced Emotions & Intellect');
        console.log('   • Module 05: Advanced Health & Anatomy');
        console.log('   • 2 Liar Game traps integrated\n');
        console.log('🎯 Progress: 500/1,000 words (50% of A2 complete)\n');
        console.log('🎊 HALFWAY THROUGH SANSKRIT A2! 🎊\n');
