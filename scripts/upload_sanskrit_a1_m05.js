...
async function uploadSanskritModule05() {
    const moduleId = 'sa_a1_m05';

    console.log(`📤 Starting upload for Sanskrit A1 Module 05...\n`);
    ...
    try {
        ...
        console.log('🎉 Sanskrit A1 Module 05 deployment complete!');
        console.log('\n📊 Summary:');
        console.log('   • 100 Sanskrit verbs uploaded (Module 05)');
        console.log('   • 500 total words across 5 modules');
        console.log('   • 10 nested lessons created');
        console.log('   • Liar Game trap: चिह्नयति vs चिह्नोति (Verb formation)');
        console.log('   • Topics: Actions, Daily Life Verbs\n');
