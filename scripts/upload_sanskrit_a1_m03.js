...
async function uploadSanskritModule03() {
    const moduleId = 'sa_a1_m03';

    console.log(`📤 Starting upload for Sanskrit A1 Module 03...\n`);
    ...
    try {
        ...
        console.log('🎉 Sanskrit A1 Module 03 deployment complete!');
        console.log('\n📊 Summary:');
        console.log('   • 100 Sanskrit words uploaded (Module 03)');
        console.log('   • 300 total words across 3 modules');
        console.log('   • 10 nested lessons created');
        console.log('   • Liar Game trap: चतुष्पाद vs पशुः (Animal classification)');
        console.log('   • Topics: Animals, Birds, Nature, Seasons, Numbers 11-20\n');
