...
async function uploadSanskritModule04() {
    const moduleId = 'sa_a1_m04';

    console.log(`📤 Starting upload for Sanskrit A1 Module 04...\n`);
    ...
    try {
        ...
        console.log('🎉 Sanskrit A1 Module 04 deployment complete!');
        console.log('\n📊 Summary:');
        console.log('   • 100 Sanskrit words uploaded (Module 04)');
        console.log('   • 400 total words across 4 modules');
        console.log('   • 10 nested lessons created');
        console.log('   • Liar Game trap: समयपालनम् (Punctuality - modern compound)');
        console.log('   • Topics: Health, Emotions, Abstract Concepts, Philosophy\n');
