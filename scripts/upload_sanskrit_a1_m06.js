...
async function uploadSanskritModule06() {
    const moduleId = 'sa_a1_m06';

    console.log(`📤 Starting upload for Sanskrit A1 Module 06...\n`);
    ...
    try {
        ...
        console.log('🎉 Sanskrit A1 Module 06 deployment complete!');
        console.log('\n📊 Summary:');
        console.log('   • 100 Sanskrit adverbs uploaded (Module 06)');
        console.log('   • 600 total words across 6 modules');
        console.log('   • 10 nested lessons created');
        console.log('   • Liar Game trap: अन्तः vs अन्तर् (Directional words)');
        console.log('   • Topics: Time, Space, Adverbs\n');
