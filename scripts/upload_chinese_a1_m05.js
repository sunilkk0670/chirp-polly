...
async function uploadChineseA1Module05() {
    try {
        console.log('🚀 Starting Chinese A1 Module 05 upload...\n');

        const filePath = path.join(__dirname, '../firestore_data/zh_a1_m05.json');
        ...
        console.log('🎉 Chinese A1 Module 05 deployment complete!');
